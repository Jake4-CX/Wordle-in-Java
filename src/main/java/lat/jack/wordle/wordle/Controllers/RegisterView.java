...
import lat.jack.wordle.wordle.Events.Register.onRegisterButtonClick;
...
public class RegisterView {
    ...
    protected void initialize() {
        ...
        getButton(0).buttonPane.addEventFilter(MouseEvent.MOUSE_PRESSED, new onRegisterButtonClick(this, 0));
        getButton(1).buttonPane.addEventFilter(MouseEvent.MOUSE_PRESSED, new onRegisterButtonClick(this, 1));
    ...
    protected void setupButtons() {
        ...
        submit.buttonPane = ButtonRegister;
        submit.buttonView = (ImageView) ButtonRegister.getChildren().get(0);
        submit.buttonText = (Text) ButtonRegister.getChildren().get(1);
        submit.buttonValue = "Register";
